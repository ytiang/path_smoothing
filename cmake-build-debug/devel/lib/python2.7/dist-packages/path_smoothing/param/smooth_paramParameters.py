...
param_description = [{'constant': False, 'description': 'if true, smoother will consider boundary or obstacle', 'pytype': 'bool', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'is_consider_boundary', 'min': None, 'default': True, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'bool'}, {'constant': False, 'description': 'if true, smoother will save distance map', 'pytype': 'bool', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'is_save_map', 'min': None, 'default': False, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'bool'}, {'constant': False, 'description': 'if false, smoother will use ceres to solve', 'pytype': 'bool', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'use_self_solver', 'min': None, 'default': False, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'bool'}, {'constant': False, 'description': 'weight for heading term', 'pytype': 'double', 'max': 100, 'is_vector': False, 'edit_method': '""', 'name': 'w1', 'min': 0, 'default': 10.0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'weight for curvature term', 'pytype': 'double', 'max': 100, 'is_vector': False, 'edit_method': '""', 'name': 'w2', 'min': 0, 'default': 5.0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'weight for obstacle term', 'pytype': 'double', 'max': 100, 'is_vector': False, 'edit_method': '""', 'name': 'w3', 'min': 0, 'default': 10.0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}]
...
class smooth_paramParameters(dict):
    def __init__(self):
